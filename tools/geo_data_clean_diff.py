...
def argparser():
    ...
    parser.add_argument('--data_dir',   type = str, default = r'D:\data\Myanmar\123/', required=False,
                        help='Path to input directory\n' )
    parser.add_argument('--output_dir', type = str, default = r'D:\data\Myanmar\test_clean1/', required=False,
