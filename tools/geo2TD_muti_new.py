            ...
            for txtfiles in glob.glob(os.path.join(root,"*.txt")):
                ...
                if(labels):
                    ...
                    for i,float_label in enumerate(float_labels):
                        ...
                        save_jpgandtxt(crop_img, label_crop, os.path.join(savepath, os.path.relpath(os.path.dirname(txtfiles), args.data_dir)), '_'+str(i)+'_10_'+os.path.basename(txtfiles))
