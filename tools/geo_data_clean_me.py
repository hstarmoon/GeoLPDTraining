...
def argparser():
    ...
    parser.add_argument('--data_dir',   type = str, default = r'D:\data\Myanmar\Myanmar_ray\Myanmar.03\data\train/', required=False,
                        help='Path to input directory\n' )
    parser.add_argument('--output_dir', type = str, default = r'D:\data\Myanmar\Myanmar_ray\Myanmar.03\data\train_clean1/', required=False,
        ...
        for root, dirs, files in os.walk(args.data_dir):
            ...
            for txtfiles in glob.glob(os.path.join(root,"*.txt")):
                ...
                if img is None:
                    ...
                    badimg+=1
                    continue                
                with open(txtfiles,'r', errors='ignore', encoding='UTF-8') as txtfile:
