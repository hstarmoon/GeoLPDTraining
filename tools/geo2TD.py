...
def label_rule_checker(labels,img_shape):
    try:
        ...
        return labels
def label_transfer(img,label,offset):
    tl=[None]*2
    br=[None]*2
...
def main(argv):
    ...
    parser.add_argument('--data_dir',   type = str, default = 'E:\\GitRepository\\GeoLPDTraining\\data', required=False,
                        help='Path to input data\n' )
    parser.add_argument('--output_dir', type = str, default = 'E:\\GitRepository\\GeoLPDTraining\\TD\\data', required=False, 
                        help='Output directory\n' )   
    parser.add_argument('--offset', default = 80, type = int, 
