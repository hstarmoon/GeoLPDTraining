...
def main(argv):
    ...
    parser.add_argument('--data_dir',   type = str, default = r'D:\data\Myanmar\test_123_tmp', required=False,
                        help='Path to input data\n' )
    parser.add_argument('--output_dir', type = str, default = r'D:\data\Myanmar\test_123_TD_tmp', required=False,
